...
struct test_values test2 = {.a = 0 , .b = 0 , .c = 0 , .x1_refer = 3 , .x2_refer = 3 , .num_test = 2};
struct test_values test3 = {.a = 0 , .b = 0 , .c = 1 , .x1_refer = 2 , .x2_refer = 2 , .num_test = 3};
struct test_values test4 = {.a = 2 , .b = 3 , .c = 0 , .x1_refer = -1.5 , .x2_refer = 0 , .num_test = 4};
struct test_values test5 = {.a = 1 , .b = 1 , .c = 1 , .x1_refer = 14 , .x2_refer = 14 , .num_test = 5};
struct test_values test6 = {.a = 1 , .b = 2 , .c = 1 , .x1_refer = -1 , 15 , .num_test = 6};
struct test_values test7 = {.a = 2 , .b = 0 , .c = -1 , .x1_refer = (-sqrt(0.5)) , .x2_refer = sqrt(0.5) , .num_test = 7};
struct test_values test8 = {.a = 0 , .b = 1 , .c = 0 , .x1_refer = 1 , .x2_refer = 1 , .num_test = 8};
...
struct test_values test11 = {.a = 1.0 , .b = 2.0 , .c = 3.0 , .x1_refer = 14 , .x2_refer = 14 , .num_test = 11};
struct test_values test12 = {.a = 0.0 , .b = 0.0 , .c = 0.0 , .x1_refer = 3 , .x2_refer = 3 , .num_test = 12};
struct test_values test13 = {.a = 0.0 , .b = 0.0 , .c = 1.0 , .x1_refer = 2 , .x2_refer = 2 , .num_test = 13};
struct test_values test14 = {.a = 2.0 , .b = 3.0 , .c = 0.0 , .x1_refer = -1.5 , .x2_refer = 0 , .num_test = 14};
struct test_values test15 = {.a = 1.0 , .b = 1.0 , .c = 1.0 , .x1_refer = 14 , .x2_refer = 14 , .num_test = 15};
struct test_values test16 = {.a = 1.0 , .b = 2.0 , .c = 1.0, .x1_refer = -1 , 15 , .num_test = 16};
struct test_values test17 = {.a = 2.0 , .b = 0.0 , .c = -1.0 , .x1_refer = (-sqrt(0.5)) , .x2_refer = sqrt(0.5) , .num_test = 17};
struct test_values test18 = {.a = 0.0 , .b = 1.0 , .c = 0.0 , .x1_refer = 1 , .x2_refer = 1 , .num_test = 18};
